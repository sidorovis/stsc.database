...
public class OptimizerDatabaseSettingsTest {
	...
	@Test
	public void testOptimizerDatabaseSettings() throws IOException, URISyntaxException {
	...
	@Test
	public void testOptimizerCreateConnectionToLiquibase() throws SQLException, IOException, LiquibaseException, URISyntaxException {
		final OptimizerDatabaseSettings ds = OptimizerDatabaseSettings.test();
		ds.migrate();
	}
}
