...
public class OrmliteOptimizerIntegerDomenTest {

	@Test
	public void testOrmliteOptimizerIntegerParameters() throws SQLException, LiquibaseException, IOException, URISyntaxException {
		...
		}
		{
			...
			final OrmliteOptimizerIntegerDomen copy = storage.loadIntegerParameters(executionCopy).get(0);
