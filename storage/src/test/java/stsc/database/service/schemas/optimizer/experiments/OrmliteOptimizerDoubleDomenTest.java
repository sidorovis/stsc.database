...
public class OrmliteOptimizerDoubleDomenTest {

	@Test
	public void testOrmliteOptimizerDoubleParameters() throws SQLException, LiquibaseException, IOException, URISyntaxException {
		...
		}
		{
			...
			final OrmliteOptimizerDoubleDomen copy = storage.loadDoubleParameters(executionCopy).get(0);
